...
module MockServer
  class HttpError
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dropConnection')
        self.drop_connection = attributes[:'dropConnection']
      end

      if attributes.has_key?(:'responseBytes')
        self.response_bytes = attributes[:'responseBytes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          delay == o.delay &&
          drop_connection == o.drop_connection &&
    ...
    def hash
      [delay, drop_connection, response_bytes].hash
    end
