...
- `docs/testing.md` — comprehensive testing documentation (530 lines) replacing the previous 245-line version. Covers test frameworks, module inventory, architecture (abstract base class hierarchy), assertion patterns, full Surefire/Failsafe configuration, parallelization, test data, coverage tooling gaps, disabled tests, anti-patterns, and CI execution.
...
### Cost/Complexity Budget Summary
...
|------|--------|-------------|
| `docs/plans/testing-improvements.md` | **Create** | Standalone copy of the improvement plan (Phases 1-4) |
| `docs/README.md` | **Minor update** | Update description of `testing.md` in the index table |
