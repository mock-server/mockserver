...
import static org.mockserver.jetty.proxy.connect.ConnectHandler.BUFFER_POOL;
...
public class ConnectConnection extends AbstractConnection {
    ...
    public void onFillable() {
        // Get a buffer
        final ByteBuffer requestBuffer = ConnectHandler.BUFFER_POOL.acquire(getInputBufferSize(), false);
        ...
        try {
            ...
            ConnectHandler.BUFFER_POOL.release(requestBuffer);
        }
    }
