...
public class DirectProxyDownstreamInitializer extends ChannelInitializer<SocketChannel> {

    private final Channel inboundChannel;
    private final boolean secure;
    private final int bufferedCapacity;

    public DirectProxyDownstreamInitializer(Channel inboundChannel, boolean secure, int bufferedCapacity) {
...
//        pipeline.addFirst("log", new LogHandler());
        ...
        // add handler
        pipeline.addLast(new DirectProxyDownstreamHandler(inboundChannel, bufferedCapacity));
    }
}
