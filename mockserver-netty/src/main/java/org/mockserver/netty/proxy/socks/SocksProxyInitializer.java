...
public final class SocksProxyInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        channelPipeline.addLast(SocksProxyHandler.getName(), new SocksProxyHandler());
    }
}
