package org.mockserver.examples.web.controller.jerseyclient;
...
@ActiveProfiles(profiles = {"backend", "jerseyClient"})
public class BooksPageJerseyClientEndToEndIntegrationTest extends BooksPageEndToEndIntegrationTest {
