...
class BodyWithContentTypeAnyOf(BaseModel):
    """
    binary response body
    """ # noqa: E501
    var_not: Optional[StrictBool] = Field(default=None, alias="not")
    type: Optional[StrictStr] = None
    base64_bytes: Optional[StrictStr] = Field(default=None, alias="base64Bytes")
    content_type: Optional[StrictStr] = Field(default=None, alias="contentType")
    __properties: ClassVar[List[str]] = ["not", "type", "base64Bytes", "contentType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "not": obj.get("not"),
            "type": obj.get("type"),
            "base64Bytes": obj.get("base64Bytes"),
