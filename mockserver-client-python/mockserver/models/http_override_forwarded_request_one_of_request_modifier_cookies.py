...
class HttpOverrideForwardedRequestOneOfRequestModifierCookies(BaseModel):
    """
    HttpOverrideForwardedRequestOneOfRequestModifierCookies
    """ # noqa: E501
    add: Optional[KeyToValue] = None
    replace: Optional[KeyToValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add": KeyToValue.from_dict(obj["add"]) if obj.get("add") is not None else None,
            "replace": KeyToValue.from_dict(obj["replace"]) if obj.get("replace") is not None else None,
