...
class OpenAPIDefinition(BaseModel):
    ...
    """ # noqa: E501
    spec_url_or_payload: Optional[StrictStr] = Field(default=None, alias="specUrlOrPayload")
    operation_id: Optional[StrictStr] = Field(default=None, alias="operationId")
    __properties: ClassVar[List[str]] = ["specUrlOrPayload", "operationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specUrlOrPayload": obj.get("specUrlOrPayload"),
