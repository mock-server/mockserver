...
class BodyAnyOf3(BaseModel):
    """
    JSON path body matcher
    """ # noqa: E501
    var_not: Optional[StrictBool] = Field(default=None, alias="not")
    type: Optional[StrictStr] = None
    json_path: Optional[StrictStr] = Field(default=None, alias="jsonPath")
    __properties: ClassVar[List[str]] = ["not", "type", "jsonPath"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['JSON_PATH']):
            raise ValueError("must be one of enum values ('JSON_PATH')")
        return value
