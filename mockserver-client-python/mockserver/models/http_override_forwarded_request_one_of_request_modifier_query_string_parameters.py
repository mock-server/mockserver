...
class HttpOverrideForwardedRequestOneOfRequestModifierQueryStringParameters(BaseModel):
    """
    HttpOverrideForwardedRequestOneOfRequestModifierQueryStringParameters
    """ # noqa: E501
    add: Optional[KeyToMultiValue] = None
    replace: Optional[KeyToMultiValue] = None
    remove: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["add", "replace", "remove"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add": KeyToMultiValue.from_dict(obj["add"]) if obj.get("add") is not None else None,
            "replace": KeyToMultiValue.from_dict(obj["replace"]) if obj.get("replace") is not None else None,
