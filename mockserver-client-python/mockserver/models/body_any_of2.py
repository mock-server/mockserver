...
class BodyAnyOf2(BaseModel):
    """
    json schema body matcher
    """ # noqa: E501
    var_not: Optional[StrictBool] = Field(default=None, alias="not")
    type: Optional[StrictStr] = None
    json_schema: Optional[Dict[str, Any]] = Field(default=None, description="JSON Schema (draft-04)", alias="jsonSchema")
    __properties: ClassVar[List[str]] = ["not", "type", "jsonSchema"]
