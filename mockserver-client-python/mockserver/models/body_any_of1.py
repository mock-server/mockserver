...
class BodyAnyOf1(BaseModel):
    ...
    match_numbers_as_strings: Optional[StrictBool] = Field(default=None, alias="matchNumbersAsStrings")
    __properties: ClassVar[List[str]] = ["not", "type", "json", "contentType", "matchType", "matchNumbersAsStrings"]
    ...
    def match_type_validate_enum(cls, value):
        ...
        if value not in set(['STRICT', 'ONLY_MATCHING_FIELDS']):
            raise ValueError("must be one of enum values ('STRICT', 'ONLY_MATCHING_FIELDS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchNumbersAsStrings": obj.get("matchNumbersAsStrings")
        })
        return _obj
