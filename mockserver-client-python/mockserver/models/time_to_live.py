...
class TimeToLive(BaseModel):
    ...
    time_to_live: Optional[StrictInt] = Field(default=None, alias="timeToLive")
    unlimited: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["timeUnit", "timeToLive", "unlimited"]
    ...
    def time_unit_validate_enum(cls, value):
        ...
        if value not in set(['DAYS', 'HOURS', 'MINUTES', 'SECONDS', 'MILLISECONDS', 'MICROSECONDS', 'NANOSECONDS']):
            raise ValueError("must be one of enum values ('DAYS', 'HOURS', 'MINUTES', 'SECONDS', 'MILLISECONDS', 'MICROSECONDS', 'NANOSECONDS')")
        return value
