...
class HttpTemplate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["delay", "templateType", "template"]
    ...
    def template_type_validate_enum(cls, value):
        ...
        if value not in set(['VELOCITY', 'JAVASCRIPT', 'MUSTACHE']):
            raise ValueError("must be one of enum values ('VELOCITY', 'JAVASCRIPT', 'MUSTACHE')")
        return value
