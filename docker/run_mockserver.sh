...
echo "java -Dfile.encoding=UTF-8 -Dmockserver.logLevel=WARN -jar $MOCKSERVER_HOME/mockserver-netty-3.3-jar-with-dependencies.jar $COMMAND_LINE_OPTS"
java -Dfile.encoding=UTF-8 -Dmockserver.logLevel=WARN -jar $MOCKSERVER_HOME/mockserver-netty-3.3-jar-with-dependencies.jar $COMMAND_LINE_OPTS
