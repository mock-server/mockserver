...
function start-up() {
  runCommand "helm --kube-context microk8s upgrade --install --namespace ${2:-mockserver} --create-namespace ${1:-} --wait --version 5.14.0 ${2:-mockserver} ${SCRIPT_DIR}/../../helm/mockserver"
