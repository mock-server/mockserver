                    ...
                    try {
                        ...
                        mockServerLogger.logEvent(
                            new LogEntry()
                                ...
                                .setMessageFormat("Loading JavaScript to validate ECMA262 regular expression in JsonSchema because java.util.regex package in Java does not match ECMA262")
                        );
