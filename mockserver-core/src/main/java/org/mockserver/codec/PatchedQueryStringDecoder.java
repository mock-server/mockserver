 ...
 */
public class PatchedQueryStringDecoder {
     ...
     */
    public PatchedQueryStringDecoder(String uri) {
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(String uri, boolean hasPath) {
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(String uri, Charset charset) {
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(String uri, Charset charset, boolean hasPath) {
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(String uri, Charset charset, boolean hasPath, int maxParams) {
     ...
     * assume that the query string is encoded in UTF-8.
     */
    public PatchedQueryStringDecoder(URI uri) {
        this(uri, HttpConstants.DEFAULT_CHARSET);
    }
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(URI uri, Charset charset) {
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(URI uri, Charset charset, int maxParams) {
     ...
     * specified charset.
     */
    public PatchedQueryStringDecoder(URI uri, Charset charset, int maxParams, boolean semicolonIsNormalChar) {
    ...
    /**
     * Returns the uri used to initialize this {@link PatchedQueryStringDecoder}.
     */
    public String uri() {
        return uri;
    }
    ...
    private static boolean addParam(String s, int nameStart, int valueStart, int valueEnd,
        ...
        System.out.println("###" + s + " " + valueStart + " " + valueEnd);
        ...
        //       4
        // ппц а не условие
        if (valueStart - valueEnd == 1 && s.charAt(valueStart - 2) != '=' ) {
            values.add(null);
            return true;
        }
