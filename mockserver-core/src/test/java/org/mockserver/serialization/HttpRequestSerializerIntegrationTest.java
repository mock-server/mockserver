...
public class HttpRequestSerializerIntegrationTest {
    ...
    public void shouldValidateHeaderValueIsList() {
        ...
        throwCorrectError(requestBytes, "4 errors:" + NEW_LINE +
            ...
            " - field: \"/headers/someHeaderName\" for schema: \"keyToMultiValue/oneOf/1/patternProperties/^\\S+$\" has error: \"instance type (string) does not match any allowed primitive type (allowed: [\"array\"])\"" + NEW_LINE +
            NEW_LINE +
    ...
    public void shouldValidateQueryStringParameterValueIsList() {
        ...
        throwCorrectError(requestBytes, "4 errors:" + NEW_LINE +
            ...
            " - field: \"/queryStringParameters/someParameterName\" for schema: \"keyToMultiValue/oneOf/1/patternProperties/^\\S+$\" has error: \"instance type (string) does not match any allowed primitive type (allowed: [\"array\"])\"" + NEW_LINE +
            NEW_LINE +
            OPEN_API_SPECIFICATION_URL);
    }
    ...
    public void shouldSerializeArray() {
        ...
        String jsonHttpRequest = new HttpRequestSerializer(new MockServerLogger()).serialize(
            new HttpRequest[]{
                new HttpRequestDTO()
                    ...
                    .setHeaders(new Headers().withEntries(
                        header("some_header_name_one", "some_header_value_one")
                    ))
                    .buildObject(),
                new HttpRequestDTO()
                    ...
                    .setHeaders(new Headers().withEntries(
                        header("some_header_name_two", "some_header_value_two")
                    ))
                    .buildObject()
            }
        );
        ...
        assertEquals("[ {" + NEW_LINE +
            ...
            "  \"headers\" : {" + NEW_LINE +
            "    \"some_header_name_one\" : [ \"some_header_value_one\" ]" + NEW_LINE +
            "  }," + NEW_LINE +
            ...
            "  \"headers\" : {" + NEW_LINE +
            "    \"some_header_name_two\" : [ \"some_header_value_two\" ]" + NEW_LINE +
            "  }," + NEW_LINE +
