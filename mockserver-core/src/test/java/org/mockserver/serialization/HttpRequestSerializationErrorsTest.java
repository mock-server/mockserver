...
public class HttpRequestSerializationErrorsTest {
    ...
    public void shouldHandleExceptionWhileDeserializingObject() {
        try {
            ...
            // then
            assertThat(iae.getMessage(), is("JsonParseException - Unrecognized token 'requestBytes': was expecting (JSON String, Number, Array, Object or token 'null', 'true' or 'false')\n" +
    ...
    public void shouldHandleExceptionWhileDeserializingArray() {
        ...
        try {
            ...
            // then
            assertThat(iae.getMessage(), is("com.fasterxml.jackson.core.JsonParseException: Unrecognized token 'requestBytes': was expecting (JSON String, Number, Array, Object or token 'null', 'true' or 'false')\n" +
                " at [Source: (String)\"requestBytes\"; line: 1, column: 25]"));
        }
    }
