...
public class ExactStringMatcherTest {
    ...
    public void shouldMatchMatchingString() {
        ...
        assertTrue(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, NottableString.not("some_value")));
        ...
        assertFalse(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, "some_value"));
    ...
    public void shouldMatchNotMatchingString() {
        ...
        assertFalse(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, NottableString.not("some_other_value")));
        ...
        assertTrue(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, "some_other_value"));
    ...
    public void shouldMatchNullMatched() {
        ...
        assertFalse(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, NottableString.not(null)));
        ...
        assertTrue(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, (String) null));
        assertTrue(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, string(null)));
    ...
    public void shouldMatchEmptyMatched() {
        ...
        assertFalse(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, NottableString.not("")));
        ...
        assertTrue(not(new ExactStringMatcher(new MockServerLogger(), string("some_value"))).matches(null, ""));
