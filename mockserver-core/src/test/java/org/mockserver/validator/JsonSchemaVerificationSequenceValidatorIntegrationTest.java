...
public class JsonSchemaVerificationSequenceValidatorIntegrationTest {
    ...
    public void shouldValidateInvalidExtraField() {
        ...
        assertThat(jsonSchemaValidator.isValid("{ \"httpRequests\": [" + NEW_LINE +
                ...
                is(
                        "1 error:" + NEW_LINE +
                                " - object instance has properties which are not allowed by the schema: [\"invalidField\"] for field \"/httpRequests/0\""
                ));
    }
        ...
        assertThat(jsonSchemaValidator.isValid("{ \"httpRequests\": [" + NEW_LINE +
                ...
                is(
                        "2 errors:" + NEW_LINE +
                                ...
                                " - instance type (boolean) does not match any allowed primitive type (allowed: [\"string\"]) for field \"/httpRequests/0/path\""
                ));
    }
    ...
    public void shouldValidateInvalidListItemType() {
        ...
        assertThat(jsonSchemaValidator.isValid("{ \"httpRequests\": [" + NEW_LINE +
                ...
                is(
                        "2 errors:" + NEW_LINE +
                                " - instance type (string) does not match any allowed primitive type (allowed: [\"object\"]) for field \"/httpRequests/0/headers/0\"" + NEW_LINE +
                                " - instance type (string) does not match any allowed primitive type (allowed: [\"object\"]) for field \"/httpRequests/0/headers/1\""
                ));
    }
